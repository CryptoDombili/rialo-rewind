...
A dedicated Rialo receipt registry/program that stores typed receipt commitments and exposes first-class lookup semantics. This should be treated as a separate protocol milestone, not silently represented as part of R1.4.2.
