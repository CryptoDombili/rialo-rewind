...
(() => {
      ...
      function issueReceipt(serverReceipt) {
        ...
        receipt.engine.textContent = "SERVER R1.4.5";
        ...
        $("#proofEngine").textContent = "SERVER R1.4.5";
      ...
      async function replayServerExecution(payload, token) {
        ...
        for (const event of events) {
          ...
          if (event.type === "workflow.started") {
            log("SERVER", `Execution ${event.executionId.slice(0, 8)} accepted by the R1.4.5 state machine.`);
