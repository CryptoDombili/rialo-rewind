...
(() => {
      ...
      function issueReceipt(serverReceipt) {
        ...
        receipt.engine.textContent = "SERVER R1.4.3";
        ...
        $("#proofEngine").textContent = "SERVER R1.4.3";
      ...
      async function replayServerExecution(payload, token) {
        ...
        for (const event of events) {
          ...
          if (event.type === "workflow.started") {
            log("SERVER", `Execution ${event.executionId.slice(0, 8)} accepted by the R1.4.3 state machine.`);
