...
R1.4 is the polished public-demo release. It combines a server-side recovery state machine, portable SHA-256 receipts, real Rialo devnet receipt anchoring, public verification, deterministic tamper detection, and shareable verification reports.
...
R1.4 freezes the visual system and public demo flow. Future work belongs in a dedicated Rialo registry/program milestone rather than further expanding this demo surface.
